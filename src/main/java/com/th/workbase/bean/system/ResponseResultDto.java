...
import com.th.workbase.common.system.SuccessEnum;
...
public class ResponseResultDto {
    ...
    public static ResponseResultDto methodError() {
        ResponseResultDto responseResult = new ResponseResultDto();
        responseResult.setSuccess(false);
        responseResult.setCode(ErrorEnum.E_405.getErrorCode());
        responseResult.setMessage(ErrorEnum.E_405.getErrorMsg());
        return responseResult;
    }
